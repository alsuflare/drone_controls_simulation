...
class DrawMav:
    ...
    def get_points(self):
        ...
        blue = np.array([0, 0.52, 1, 0.4])
        lighterblue = np.array([0.59, 0.8, 1, 0.4])
        grey = np.array([0.66, 0.66, 0.66, 0.4])
        darkgrey = np.array([0.22, 0.22, 0.22, 0.4])
        meshColors = np.empty((13, 3, 4), dtype=np.float32)
        meshColors[0] = grey
        meshColors[1] = grey
        meshColors[2] = grey
        meshColors[3] = grey
        meshColors[4] = darkgrey
        meshColors[5] = darkgrey
        meshColors[6] = darkgrey
        meshColors[7] = darkgrey
        meshColors[8] = blue
        meshColors[9] = blue
        meshColors[10] = lighterblue
        meshColors[11] = lighterblue
        meshColors[12] = blue
